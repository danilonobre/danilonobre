...
<p>The biggest challenge selling Bleez E-commerce was to explain to the market what Bleez really do, because the biggest part of the local market doesn't understand technically how an e-commerce works, and this makes more difficult explain that Bleez only act with the platform, in other words, that Bleez only sells the system they need to display their products and capture a sale.</p>
