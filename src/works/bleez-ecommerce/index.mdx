...
project: I was responsible for growth and product design in the Bleez project, where I utilized UX research to create a seamless user experience. I focused on data-driven growth strategies to optimize user acquisition, retention, and engagement, ultimately contributing to the platform's success
tags: [
    'Heatmap',
    'Metrics',
    'UX Research',
