...
/**
 * Links de contato com SVG icons inline.
 * Ícones de design-system.md — email e LinkedIn.
 */
export function Contacts() {
  return (
    <ul className="contacts">
      ...
      <li>
        <a
          href="https://www.linkedin.com/in/danilonobre"
          className="contact-link"
          target="_blank"
